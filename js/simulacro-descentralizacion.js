...
const topicId = 'descentralizacion'; // Identificador único para el tema actual
...
fetch('json/questions-descentralizacion.json') // Verifica que esta ruta sea correcta
    .then(response => response.json())
    .then(data => {
        if (data.length === 0) {
            console.error("El archivo 'questions-descentralizacion.json' está vacío o no tiene datos.");
        } else {
